          ...
          {banners.map(item => {
            return (
              <div
                ...
                // }}
              >
                <Image src={item.imageUrl} fallback="http://chcblogs.com/lib/images/error.png" />
              </div>
            );
          })}
        </Carousel>
          ...
          return (
            ...
            >
              <div className="posterImg" style={{ position: 'relative' }}>
                <img src={`${item.picUrl}?param=300y200`} alt="" style={{ width: '100%', height: '9.688rem', borderRadius: '0.75rem' }} />
                <PlayCircleTwoTone
                  className="hover1"
